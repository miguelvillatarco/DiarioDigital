...
public class clsMenuOps {
	...
	public clsMenuOps(int id, int padre, String nombre, String etiqueta, String icono, String pagina, int habilitado){
		this.id=id;
		this.padre=padre;
		this.nombre=nombre;
...
// String sql= "SELECT id, padre, nombre, etiqueta, icono, pagina, habilitado FROM menu order by id";
